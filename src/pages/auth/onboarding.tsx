...
const Onboarding = () => {
  ...
  const submitName = async () => {
    ...
    try {
      ...
      const { error: updateError } = await supabase
        ...
        .update({
          name,
          referrer_code: localStorage.getItem("referrer_code") || null,
        })
        .eq("id", profile.id)
  ...
  return (
    <div className="min-h-screen flex justify-center lg:items-center  px-2 relative">
      <div className="h-screen relative w-fit flex flex-col items-center justify-center ">
        {error !== null && (
          <div
