...
const SigninForm = () => {
  ...
  return (
    <div className="flex justify-center w-full max-w-105">
      <div className="w-full px-5 py-7.5 lg:p-10 bg-white rounded-[10px] animate-fadeIn h-fit shadow-[#0000001A] shadow-md">
        ...
        {message !== null && (
          <div
            className={` bg-red-500/10 text-[#EF4444] border-red-500/20 border p-3 rounded-md mb-5 text-[12px] flex items-center gap-2`}
          >
        ...
        <div className="w-full">
          <form onSubmit={handleSignin} className="w-full  text-[#111827]">
            <label
              htmlFor="email"
              className="block text-left text-sm font-medium mb-2 text-[#111827]"
            >
              Email
            </label>
            <div className="relative group w-full mb-5">
              <input
                ...
                className=" peer w-full border text-base py-2.5 px-3.5  border-[#EDE9FE] transition-all ease-linear duration-[.2s] rounded-md outline-none focus:border-[#9013fe]"
                required
            ...
            <div className="relative">
              <div className="relative group w-full">
                <input
                  ...
                  id="password"
                  placeholder="••••••••"
                  className="peer w-full border py-2.5 text-base px-3.5 border-[#EDE9FE] transition-all ease-linear duration-[.2s] rounded-md outline-none focus:border-[#9013fe]"
                  required
            ...
            <button
              type="submit"
              className="w-full h-13.75 gap-2 flex justify-center text-base items-center p-2.75 text-center bg-[#9013FE] text-white  font-medium border-none transition-colors ease-linear  rounded-[100px] hover:bg-[#6D28D9]"
            >
              {" "}
              Sign in
            </button>
          ...
          <button
            ...
            className="border py-3 px-3.5 text-sm w-full gap-2 text-[#111827] border-[#EDE9FE] rounded-md hover:bg-[#F5F3FF] transition-colors flex items-center justify-center relative"
          >
            <img
