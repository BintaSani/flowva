...
const SignupForm = () => {
  ...
  return (
    <div className="flex justify-center w-full max-w-105">
      <div className="w-full px-5 animate-fadeIn py-7.5 lg:p-10 bg-white rounded-[10px] h-fit shadow-[#0000001A] shadow-md">
        ...
        {message !== null && (
          <div
            ...
            }    border p-3 rounded-md mb-5 text-[12px] flex items-center gap-2`}
          >
        ...
        <div className="w-full">
          <form onSubmit={handleSignup} className="w-full  text-[#111827]">
            <label
              htmlFor="email"
            ...
            <div className="relative">
              <div className="relative group w-full">
                <input
                  ...
                  placeholder="••••••••"
                  className=" peer w-full border py-2.75 px-3.5 text-base  border-[#EDE9FE] transition-all ease-linear duration-200 rounded-md outline-none focus:border-[#9013fe]"
            ...
            <button
              type="submit"
              className="w-full h-13.75 gap-2 mt-5 flex justify-center text-base items-center p-2.75 text-center bg-[#9013FE] text-white  font-medium border-none transition-colors ease-linear  rounded-[100px] hover:bg-[#6D28D9]"
            >
              {" "}
              Sign up
            </button>
