    ...
    <div className="shadow-[0_5px_15px_rgba(0,0,0,0.05)] transition-all rounded-2xl hover:-translate-y-1.25 hover:shadow-[0_10px_25px_rgba(0,0,0,0.1)] border border-[#f3f4f6] overflow-hidden duration-200">
      <div className="p-4 relative border border-b-[#f3f4f6] bg-[#eef2ff] border-t-0 border-r-0 border-l-0">
        <h3 className="text-lg font-semibold flex items-center gap-2 text-gray-700">
          <FaAward className="text-[#9013fe] size-5" />
          Points Balance
        </h3>
      </div>
      <div className="p-4">
        <div className="flex justify-between items-center">
          <h4 className="font-extrabold text-[36px] text-[#9013fe] m-[10px_0]">
            {profile?.total_points ?? 0}
          </h4>
          <div className="">
            <div className="bg-transparent my-0 mx-auto overflow-hidden h-25 w-25">
              <svg
              ...
              >
                <defs>
                  ...
                  <linearGradient
                    ...
                    y2="67.8030014038086"
                  >
                    <stop offset="0%" stop-color="rgb(255,234,0)">
                      {" "}
                    </stop>
                    <stop offset="50%" stop-color="rgb(255,199,0)"></stop>
                    <stop offset="100%" stop-color="rgb(255,165,0)"></stop>
                  </linearGradient>
                  <linearGradient
                  ...
                  >
                    <stop offset="0%" stop-color="rgb(255,233,0)"></stop>
                    <stop offset="50%" stop-color="rgb(255,199,0)"></stop>
                    <stop offset="100%" stop-color="rgb(255,166,0)"></stop>
                  </linearGradient>
                  <linearGradient
                  ...
                  >
                    <stop offset="0%" stop-color="rgb(255,173,0)"></stop>
                    <stop offset="50%" stop-color="rgb(255,143,0)"></stop>
                    <stop offset="100%" stop-color="rgb(255,113,0)"></stop>
                  </linearGradient>
                  ...
                  <linearGradient
                    ...
                    y2="0"
                  >
                    <stop offset="0%" stop-color="rgb(255,234,0)"></stop>
                    <stop offset="50%" stop-color="rgb(255,228,0)"></stop>
                    <stop offset="100%" stop-color="rgb(255,221,0)"></stop>
                  </linearGradient>
                  <linearGradient
                ...
                <g clip-path="url(#__lottie_element_2)">
                  ...
                  <g
                    transform="matrix(1.3390071392059326,1.4856157302856445,-1.4856157302856445,1.3390071392059326,450.9334716796875,-93.31781005859375)"
                    opacity="0.0029999999999432703"
                    style={{ display: "none" }}
                  >
                    <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                      <path
                  ...
                  <g
                    transform="matrix(0.8007730841636658,1.3851923942565918,-1.3851923942565918,0.8007730841636658,238.17669677734375,106.29568481445312)"
                    opacity="0.003333333333387145"
                    style={{ display: "none" }}
                  >
                    <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                      <path
        ...
        <div className="mt-4">
          <div className="flex justify-between text-sm mb-1">
            ...
            <span className="font-medium">{profile?.total_points}/5000</span>
          </div>
